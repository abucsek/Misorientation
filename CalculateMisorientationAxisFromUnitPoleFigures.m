...
Orientation = [-0.65576      0.73111      -0.1336      0.12851];
R = [.0781;  .0873;  .1406;  .1406;  .104;  .104];
HKL = [1 0 0;  1 0 -1;  -1 -2 1;  -1 2 1;  -1 1 1;  -1 -1 1];
spotStart_PF = [-.9292 -.1322 .3451;  -.5873 -.1897 .7868;  .4768 -.6328 -.6101
    -.7862 -.5967 -.1607;  -.278 -.8818 .381;  .5443 -.3245 -.7736];
spotEnd_PF = [-.9896 -.1075 .09604;  -.7461 -.171 .6428;   .5483 -.6489 -.5275;
    -.7177 -.5648 -.4073;  -.3538 -.8891 .2903;  .6996 -.3689 -.6119];
spotMax_PF = [-0.5540   -0.8000    0.2305;  -0.3072   -0.6081    0.7321;
    0.5047   -0.6414   -0.5779;  -0.7459   -0.5682   -0.3475;
    -0.3081   -0.8847    0.3499;  0.6105   -0.3568   -0.7071];
